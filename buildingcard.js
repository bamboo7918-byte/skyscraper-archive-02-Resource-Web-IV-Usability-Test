...
const BUILDING_IMAGES = {
  "one-canada-square": "743dd371c92a7dc5179b17da39a7f390.jpg",
  "101-collins-street": "fa0b60f8990db77379d7b3044f34a306.jpg",
  ...
  "al-hamra-tower": "8e6f0856f8f30eacf5410611b1477add.jpg",
...
const BUILDINGS = [
  ...
  },
  {
    ...
    "lng": 144.9718,
    "images": [
      "fa0b60f8990db77379d7b3044f34a306.jpg",
      "8bf7b7e4e6b42dd1cdf3482b8a221b5e.jpg",
      "con1.jpg",
  ...
  },
  {
    ...
    "images": [
      ...
      "con4.jpg",
      "a81946df9750d79ec0f3eeffd31e6c29.jpg"
    ]
  },
  {
    "id": "al-hamra-tower",
...
function renderBuildingSvg(id, w, h, mode) {
  ...
  const barWidth = w * 0.30;
  const barX = mx - barWidth / 2;

  const art = `<rect x="${barX.toFixed(2)}" y="${(ground - barHeight).toFixed(2)}" width="${barWidth.toFixed(2)}" height="${barHeight.toFixed(2)}" fill="${blue}" stroke="none"/>`;
